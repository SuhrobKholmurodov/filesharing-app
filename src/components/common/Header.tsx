...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-orange-100/40 backdrop-blur-md px-[200px] shadow-md transition-all duration-500">
      <div className="container mx-auto px-4 sm:px-8 py-4 flex justify-between items-center">
        ...
        >
          ...
          <span className="text-xl font-semibold inline">FileShare</span>
        </Link>
